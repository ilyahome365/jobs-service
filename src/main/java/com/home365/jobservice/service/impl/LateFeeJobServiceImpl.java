...
//            }
            long feeAccountManagerPercentage = getAmount(lateFeeConfiguration, transactions);
    ...
    private long getAmount(LateFeeConfiguration lateFeeConfiguration, Transactions transactions) {
